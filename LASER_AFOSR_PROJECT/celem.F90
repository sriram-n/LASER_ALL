...
!		(1) - H1 field for heat, (2) - Hcurl for Maxwell trace (2 components)
!		(3) - Hdiv trace for heat (4) - L2 field for Maxwell

      nbcond(1)=0; nbcond(2)=1; nbcond(3)=1; nbcond(4)=0
...
!     redirect to the system routine
      call celem_systemM(Mdle,Idec, Nrdofs,Nrdofm,Nrdofc,Nodm,NdofmH,NdofmE,NdofmV,NdofmQ,Nrnodm,Bload,Astif)
!
