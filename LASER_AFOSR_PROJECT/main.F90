...
!
      ...
      integer :: ic, iel, nr_elem_to_refine,iso_ans,iii,info,nonlin_steps
!
!----------------------------------------------------------------------
!
!     display menu
...
!                             option label      // explanation                // default value     // parameter
      ...
      call get_option_string( '-file-geometry'   , 'Geometry file'             , './files/fiber_prism_short_cc', FILE_GEOM   )
...
!  ...single cube problem: do not forget to reset the flag in the control file
      call get_option_real(   '-omega'              , 'OMEGA'                     , PI             , OMEGA        )
      call get_option_real(   '-waist'              , 'BEAM_WAIST'                , 0.5d0               , BEAM_WAIST  )
      call get_option_int(    '-ibc'                , 'IBCFlag'                   , 1                  , IBCFlag     )
...
subroutine setAnisoRef(info, info1)
