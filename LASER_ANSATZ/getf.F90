...
!  .....time harmonic Maxwell
        ...
        call my_cross_product(ANSATZVEC,valE(1:3,2),zaux2)
        zaux2 = ZI*zaux2
        zJval(1) = DvalE(3,2,2) - DvalE(2,2,3) +zaux2(1) - zaux*ValE(1,1)
        zJval(2) = DvalE(1,2,3) - DvalE(3,2,1) +zaux2(2) - zaux*ValE(2,1)
        zJval(3) = DvalE(2,2,1) - DvalE(1,2,2) +zaux2(3) - zaux*ValE(3,1)
        end select
!
!
!==============================================================================
