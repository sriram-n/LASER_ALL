...
!  ...kappa, deltaT, Nsteps, HEAT_LOAD for the heat equation
  double precision :: DELTAT, TMAX, HEAT_LOAD
  double precision, parameter :: KAPPA = 1.38d0/(2201.d0*703.d0)
...
!$OMP THREADPRIVATE(DANSATZVEC)   
  integer			   :: AZINUM = 1
  double precision, dimension(3) :: BETA = (/0.d0,0.d0,-1.45009d0/)
!
!............NON-DIMENSIONALIZATION....................
!  ...Parameters for the gain function
  double precision, parameter :: REF_INDEX_CORE = 1.4501d0
  double precision, parameter :: REF_INDEX_CLAD = 1.45d0
   REAL*8 ALPHA_HEAT
  PARAMETER (ALPHA_HEAT = 1.285D-5)
  REAL*8 TAU
