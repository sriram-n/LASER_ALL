...
!c
!c  ..... 1st loop through enriched H1 test functions
      do k1=1,nrdofHH
        v1 = shapHH(k1)
...
!c
!c  .......2nd loop through enriched H1 test functions
        do k2=k1,nrdofHH
          v2 = shapHH(k2)
...
!c  .......end 1st loop through enriched H1 test functions
        enddo
!c  .......end 2nd loop through enriched H1 test functions
      enddo
!c  .......end loop through integration points
    enddo
    if (iprint.eq.2) then
      do i=1,10
        do j=1,i-1
