...
!
subroutine getf(Mdle,X, Jval,curlJval)
!
...
!
      ...
      VTYPE,dimension(3),       intent(out) :: curlJval
!------------------------------------------------------------------------------
!      
!     exact solution
...
!
      ...
      curlJval(1) = DvalE(3,1,2) - DvalE(2,1,3)
      curlJval(2) = DvalE(1,1,3) - DvalE(3,1,1)
      curlJval(3) = DvalE(2,1,1) - DvalE(1,1,2)
